...
public struct Configuration {
  public typealias TextSelectionHandler = (TextSelectionPayload) -> Void
  ...
  public func css(isLight: Bool, alignment: TextAlignment) -> String {
    ...
    let fontSpecificCSS =
      !fontType.additionalCSSProperties.isEmpty ? "* { \(fontType.additionalCSSProperties) }" : ""
  ...
  public func generateCompleteCSS(
    colorScheme: RichTextColorScheme? = nil, alignment: TextAlignment = .leading
  ) -> String {
