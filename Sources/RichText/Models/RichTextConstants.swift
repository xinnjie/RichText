...
public struct RichTextConstants {
  ...
  public static let textSelectionHandler = "textSelection"
  ...
  public static let systemFontName =
  ...
  public static let linkDecorationCSS =
  ...
  public static let textSelectionScript = """
    (function () {
      var scheduled = false;
      ...
      function selectionPayload() {
        ...
        var block = node && node.closest ? node.closest(blockSelector) : null;
