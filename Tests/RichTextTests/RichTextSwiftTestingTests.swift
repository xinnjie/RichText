...
struct RichTextAllTests {
  ...
  struct FontTypeTests {
    ...
    @Test(
      "Font types return correct names",
      arguments: [
  ...
  struct ConstantsTests {
    ...
    func constantsValidation() {
      ...
      #expect(RichTextConstants.textSelectionHandler == "textSelection")
  ...
  @Suite("Text Selection Payload Tests")
  struct TextSelectionPayloadTests {

    @Test("Normalization trims selection text")
    ...
    @Test("Normalization ignores blank selections")
    func ignoresBlankSelections() {
      let payload = normalizeTextSelectionPayload(
        selectedText: "   ",
        contextText: "Paragraph text"
      )
    ...
    @Test("Normalization falls back to selected text when context missing")
    func fallsBackToSelectedText() {
      let payload = normalizeTextSelectionPayload(
        selectedText: "phrase",
        contextText: "   "
      )
  ...
  struct EnumExtensionTests {
    ...
    @Test(
      "TextAlignment HTML descriptions",
      arguments: [
  ...
  struct NewFeaturesTests {
    ...
    @Test(
      "Background color CSS generation",
      arguments: [
